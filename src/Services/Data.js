...
export const CASE_STUDIES = [
  {
    ...
    result: {
      content: [
        ...
        'The result is a seemless end-to-end experience that is visually unified and easily maintainable. There was a strong focus on simplicity and ease of use to lessen the learning curve that other logistics software requires. To add to this the user experience is streamlined, appealing and fully transparent for all invested parties.',
  ...
  },
  {
    id: 'ocean',
    title: 'Ocean',
    subtitle: 'A Princess Carribean cruise experience, reimagined.',
    ...
    solution: {
      content: [
        ...
        'I knew that by creating a simple and intuitive interface that would be somewhat familiar to them through other messaging apps, that I would have a good base to form the UI of the messaging app from. The callenging part of my assignment was integrating less traditional sharing options to the app as well as group voice and video calling. The app is quite featureful so keeping it simple proved quite a challenge.',
      ],
      images: [
        'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/FreightWeb/truck-on-mountain-road.jpg',
      ],
    ...
    result: {
      content: [
        "The resulting app is exactly what I intended it to be— familiar yet fresh, intuitive, and full of all the features you can expect from another messaging app. Plus it offered other unexpected features such as event sharing made possible by the ship's onboard local network.",
        '',
      ],
      images: [
        'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/FreightWeb/truck-on-mountain-road.jpg',
...
export const PROJECTS = [
  ...
  },
  {
    ...
    url: '/work/xinova',
    description:
      "With thousands of unused patents available and new problems waiting to be solved every single day, Xinova's mission was to find useful applications for existing patents.",
    image:
